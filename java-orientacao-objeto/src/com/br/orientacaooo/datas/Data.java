...
public class Data {
    public static void main(String[] args) throws ParseException {
        ...
        System.out.println("Sem formatação "+x);
        System.out.println("Data Formatada com padrão dd/MM/yyyy HH:mm:ss => "+format3.format(x));
        ...
        System.out.println("Data Formatada com padrão dd/MM/yyyy HH:mm:ss => "+format3.format(x2));
